...
<body id="page-top">
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0"
      ...
      <div class="container-fluid d-flex flex-column p-0">
        ...
        <ul class="navbar-nav text-light" id="accordionSidebar">
          ...
          <li class="nav-item">
            <a class="nav-link" href="profile.html"><i class="fas fa-user"></i><span style="font-weight: bold">User
                Mgmt</span></a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="../index.html"><i class="far fa-user-circle"></i><span
          ...
          <div class="container-fluid">
            ...
            <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
              <div class="input-group">
                <input class="bg-light form-control border-0 small" type="text" placeholder="Search for ..." /><button
                  class="btn btn-primary py-0" type="button" style="background: #af7505; border-color: #af7505">
            ...
            <ul class="navbar-nav flex-nowrap ms-auto">
              ...
              <li class="nav-item dropdown no-arrow mx-1">
                <div class="nav-item dropdown no-arrow">
                  ...
                  <div class="dropdown-menu dropdown-menu-end dropdown-list animated--grow-in">
                    <h6 class="dropdown-header" style="background: #af7505; border-color: #af7505">
                      alerts center
                    </h6>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                      ...
                      <div>
                        <span class="small text-gray-500">October 13, 2023</span>
                      ...
                      <div>
                        <span class="small text-gray-500">October 14, 2023</span>
                        <p>
                          MWK9000.29 has been deposited into your account!
                        </p>
                      </div>
                    </a><a class="dropdown-item d-flex align-items-center" href="#">
                      <div class="me-3">
                      ...
                      <div>
                        <span class="small text-gray-500">October 15, 2023</span>
                        <p>
              ...
              <li class="nav-item dropdown no-arrow">
                <div class="nav-item dropdown no-arrow">
                  <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span
                      class="d-none d-lg-inline me-2 text-gray-600 small">Administrator&nbsp;</span><img
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow">
            <div class="card-header py-3">
              <p class="text-primary fw-bold m-0" style="--bs-primary: #af7505; --bs-primary-rgb: 175, 117, 5">
                User Infomation
              </p>
            </div>
            <div class="card-body">
           ...
           ?>     <td>   <?php    ?>
                        <img class="rounded-circle me-2" width="30" height="30"
                          src="<?php echo $row['avatar']   ?>" /><?php echo $row['first_name']   ?>
                      </td>
                      <td><?php echo $row['last_name']   ?></td>
                      <td><?php echo $row['role']   ?></td>
                      <td><?php echo $row['gender']   ?></td>
                      <td>
                        <a class="btn btn-primary" role="button" style="background: #af7505"
                          href="profile.html">EDIT</a>
                      </td>
                      <td>
               
                        <button id="<?php echo $row['user_id']  ?>" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="deleteUser(event,'<?php echo $row['first_name']   ?>','<?php echo $row['last_name']   ?>')"  class="btn btn-primary delete" style="background: #af7505">
                          DELETE
                        </button>
                      </td>
                    </tr>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" id="confirm-delete" >delete</button>
      </div>
    </div>
  </div>
</div>
  ...
  </div>  <script src="../deleteuser.js" ></script>
